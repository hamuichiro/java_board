...
public class BoardServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		case "/edit":
			...
			break;
		case "/update":
			for (PostBean updatePost : this.postBeanList) {
				String targetId = updatePost.getId();
				if (targetId.equals(request.getParameter("id"))) {
					int updateIndex = postBeanList.indexOf(updatePost);
					...
					this.postBeanList.set(updateIndex, updatePost);
